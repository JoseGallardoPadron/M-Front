...
export class KardexEggComponent implements OnInit {
  ...
  onKardexUpdated(kardex: TypeKardex): void {
    ...
    if (existingIndex > -1) {
      ...
      // Si el kardex actualizado es el seleccionado actualmente, actualizar selectedKardexData
      if (this.selectedKardex === kardex.id) {
      ...
      // Si no hay ningún kardex seleccionado, seleccionar este
      if (this.selectedKardex === null) {
    ...
    // Re-filtrar los movimientos en caso de que el kardex seleccionado haya cambiado
